...
#define MODO 1              /* 0 = Gera, 1 = Executa, 2 = Compila os registros gerais*/
...
#define SHOW_ONLY_ANSWER 0           /* 1 = True, 0 = False,*/
#define SHOW_ON_TERMINAL 1           /* 1 = True, 0 = False, printa no terminal se verdadeiro e se falso mostra uma barra de progresso*/
#define METHOD_USE 5                 /* 0 = Todas exceto a Gulosa, 1 = MOPT, 2 = BranchBound, 3 = MOP, 4 = MOT, 5 = Gulosa*/
