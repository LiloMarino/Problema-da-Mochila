...
#define MODO 1              /* 0 = Gera, 1 = Executa, 2 = Compila os registros gerais, 3 = Compila os csv*/
#define NUMERO_DE_CASOS 1
...
#define SHOW_ONLY_ANSWER 0           /* 1 = True, 0 = False, Se falso printa todos os casos testados tanto nos arquivos quanto no terminal*/
#define SHOW_ON_TERMINAL 1           /* 1 = True, 0 = False, printa no terminal se verdadeiro e se falso mostra uma barra de progresso*/
#define SHOW_LIMITANT 0              /* 1 = True, 0 = False, Se verdadeiro mostra a comparação do limitante , SHOW_ON_TERMINAL precisa ser verdadeiro para funcionar*/
#define METHOD_USE 1                 /* 0 = Todas exceto a Gulosa, 1 = BranchBound, 2 = MOPT, 3 = MOP, 4 = MOT, 5 = Gulosa*/
