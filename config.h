...
#define CLASSE_DA_MOCHILA 1 /* 0 = Classe Custom, 1 = Classe P1, 2 = Classe P2, 3 = Classe M1, 4 = Classe M2, 5 = Classe G1, 6 = Classe G2 */
...
#define METHOD_USE 0                 /* 0 = Todas exceto a Gulosa, 1 = BranchBound, 2 = MOPT, 3 = MOP, 4 = MOT, 5 = Gulosa*/
